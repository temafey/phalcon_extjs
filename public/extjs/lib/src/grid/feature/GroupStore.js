...
Ext.define('Ext.grid.feature.GroupStore', {
    ...
    onUpdate: function(store, record, operation, modifiedField\Names) {
        var me = this,
        ...
        if (store.isGrouped()) {
            if (modifiedField\Names && Ext.Array.contains(modifiedField\Names, me.groupingFeature.getGroupField())) {
            ...
            // and, if in a grouped store, on the first and last records in the group.
                ...
                me.fireEvent('update', me, record, operation, modifiedField\Names);
                ...
                // Do not pass modifiedField\Names so that the TableView's shouldUpdateCell call always returns true.
                if (firstRec !== record) {
