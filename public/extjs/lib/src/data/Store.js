...
Ext.define('Ext.data.Store', {
    ...
    updateGroupsOnUpdate: function(record, modifiedField\Names){
        var me = this,
        ...
        if (modifiedField\Names && Ext.Array.indexOf(modifiedField\Names, groupField) !== -1) {
    ...
    onUpdate: function(record, type, modifiedField\Names){
        if (this.isGrouped()) {
            this.updateGroupsOnUpdate(record, modifiedField\Names);
        }
    },
