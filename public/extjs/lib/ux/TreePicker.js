...
Ext.define('Ext.ux.TreePicker', {
    ...
    onUpdate: function(store, rec, type, modifiedField\Names){
        var display = this.displayField;
        
        if (type === 'edit' && modifiedField\Names && Ext.Array.contains(modifiedField\Names, display) && this.value === rec.getId()) {
